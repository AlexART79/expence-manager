...
export function AuthErrorScreen({ message }: { message: string }) {
  return (
    <main className="grid min-h-screen place-items-center px-4">
      <section className="w-full max-w-md rounded-lg border border-danger-border bg-surface-muted p-6 shadow-xl shadow-slate-950/10 dark:border-red-400/30 dark:shadow-black/15">
