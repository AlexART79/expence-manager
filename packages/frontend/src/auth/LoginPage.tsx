...
export function LoginPage({ authClient, isDark, setIsDark }: LoginPageProps) {
  return (
    <main className="relative grid min-h-screen place-items-center overflow-hidden px-4 py-10">
      ...
      <section className="relative w-full max-w-md rounded-lg border border-line/35 bg-surface-muted/95 p-7 shadow-2xl shadow-slate-950/15 backdrop-blur sm:p-8 dark:border-line/10 dark:shadow-black/30">
